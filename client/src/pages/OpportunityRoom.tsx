...
export default function OpportunityRoom() {
  ...
  const sectionContent: Record<RoomSection, React.ReactNode> = {
    ...
    meddpicc: <MeddpiccEvidence clientId={clientId} opportunityId={opportunityId} meddpicc={meddpicc} />,
    bluesheet: <BlueSheetWorkspace clientId={clientId} opportunity={opportunity} />,
    strategy: <StrategyWorkspace opportunity={opportunity} contacts={contacts as any[]} meddpicc={meddpicc} />,
    spin: <SpinWorkspace opportunity={opportunity} meddpicc={meddpicc} />,
    actions: <ActionWorkspace clientId={clientId} opportunityId={opportunityId} />,
  };
