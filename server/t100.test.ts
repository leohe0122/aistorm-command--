...
vi.mock("./db", () => ({
  ...
  getAllClientsWithVisitStats: vi.fn().mockResolvedValue([
    { id: 1, name: "美的集团", industry: "智能制造", stage: "进门", priority: "P0", keywords: ["AI", "数字化"], notes: null, visitCount: 0, lastVisitDate: null, createdAt: new Date(), updatedAt: new Date() },
    { id: 2, name: "大疆创新", industry: "无人机/消费电子", stage: "建图", priority: "P0", keywords: ["合规", "数据安全"], notes: null, visitCount: 0, lastVisitDate: null, createdAt: new Date(), updatedAt: new Date() },
  ]),
