...
const BUILD_MARKER = "20260823-ai-guidance-gpt4omini-timeout-v6";
...
async function startServer() {
  ...
  app.get("/__version", (_req, res) => {
    ...
    res.status(200).json({
      ...
      aiGuidanceRoute: "contextual-guidance-gpt4omini-v6",
      serviceWorker: "20260823-ai-guidance-gpt4omini-timeout-v6",
      ts: Date.now(),
    });
  });
