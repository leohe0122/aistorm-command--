...
## 战场地图阶段条与客户品牌标识
- [ ] 为“建图”阶段提供与其他阶段同等清晰的专属颜色和选中状态
- [ ] 支持点击销售阶段节点后筛选显示该阶段客户，并提供返回全部客户的明确入口
- [ ] 在客户名称旁显示可信的企业 Logo，缺失资产时回退为统一首字母徽标
- [ ] 完成阶段筛选与客户品牌标识的回归、截图核验、发布与 GitHub 同步

> 生产核验记录：当前点击“建图”会展开阶段指南，但仍显示 7/7 户客户；需继续修复阶段筛选状态更新。
- [ ] 更新 PWA 缓存版本，确保生产浏览器加载最新阶段筛选脚本
