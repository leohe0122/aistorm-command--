...
## 旧版活跃战线模块精简
- [ ] 审计战场地图“活跃战线”与新版客户/商机视图的全部重叠区域（实现已完成，待生产验收）
- [ ] 移除旧版客户展开态及商机详细清单，不保留兼容层（实现已完成，待生产验收）
- [ ] 移除旧版 MEDDPICC、Win Strategy、SPIN、效能基线等混合标签入口（实现已完成，待生产验收）
- [ ] 验证战场地图到客户作战台及商机作战室的新版导航回归
